...
from pattern_formation3 import *
...
coords, order = who_goes_where((bot1, bot2, bot3), vertices, True)
...
while not rospy.is_shutdown():
    if not formed:
        ...
        ((goal1.x,goal1.y),(goal2.x,goal2.y),(goal3.x,goal3.y))=new_goal(x,y,order)
        speed0 = move(goal, x, y, theta, speed0)
